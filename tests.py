...
@pytest.mark.parametrize(
    ...
    [
        ["MONDAY", date(2021, 11, 1), date(2021, 11, 1), (RECYCLING, GARDEN)],
        ...
        ["MONDAY", date(2021, 11, 9), date(2021, 11, 15), (RECYCLING, GARDEN)],
        ["FRIDAY", date(2021, 11, 1), date(2021, 11, 5), (RECYCLING, GARDEN)],
        ["FRIDAY", date(2021, 11, 4), date(2021, 11, 5), (RECYCLING, GARDEN)],
        ["FRIDAY", date(2021, 11, 5), date(2021, 11, 5), (RECYCLING, GARDEN)],
        ...
        ["FRIDAY", date(2021, 11, 13), date(2021, 11, 19), (RECYCLING, GARDEN)],
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ["MONDAY", date(2022, 1, 5), date(2022, 1, 10), (RECYCLING, GARDEN)],  # back to normal
        ...
        ["TUESDAY", date(2022, 1, 6), date(2022, 1, 11), (RECYCLING, GARDEN)],  # back to normal
        ...
        ["WEDNESDAY", date(2022, 1, 7), date(2022, 1, 12), (RECYCLING, GARDEN,)],  # back to normal
        ...
        ["THURSDAY", date(2022, 1, 8), date(2022, 1, 13), (RECYCLING, GARDEN)],  # back to normal
        ...
        ["FRIDAY", date(2022, 1, 9), date(2022, 1, 14), (RECYCLING, GARDEN)],  # back to normal
    ],
)
